      ...
      <div className="max-w-5xl mx-auto">
        ...
        {!orderDetails ? (
          <div className="bg-white border-[6px] border-winterella-black p-16 rounded-[40px] text-center">
            <p className="text-gray-400 font-inter italic text-lg">
              Order not found.
            </p>
          </div>
        ) : (
          <div className="bg-white border-[6px] border-winterella-black p-8 md:p-16 rounded-[40px] shadow-2xl relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16 pb-12 border-b-2 border-gray-100">
              ...
              <div className="space-y-4">
                <span className="text-[10px] uppercase tracking-[0.3em] text-gray-400 font-inter block">
                  Placement info
                </span>
                ...
                <div className="flex flex-wrap gap-3">
                  <span
                    className={`px-4 py-1 rounded-full text-[10px] uppercase tracking-widest font-bold border-2 ${
                      orderDetails.isPaid
                  ...
                  <span
                    className={`px-4 py-1 rounded-full text-[10px] uppercase tracking-widest font-bold border-2 ${
                      orderDetails.isDelivered
                        ? "border-green-100 bg-green-50 text-green-700"
                        : "border-winterella-yellow/20 bg-winterella-yellow/5 text-winterella-yellow"
                    }`}
                  >
            ...
            <div className="space-y-8 mb-16">
              <h3 className="text-xl font-oswald uppercase tracking-widest mb-8 border-b border-gray-100 pb-2">
                Ordered Items
              </h3>
              <div className="space-y-6">
                {orderDetails.orderItems.map((item) => (
                  <div
                    key={item.productId}
                    className="flex gap-8 items-center bg-gray-50/50 p-4 rounded-3xl border border-gray-100 hover:border-winterella-black/20 transition-all"
                  >
                    <img
                      src={item.image}
                      alt={item.name}
            ...
            <div className="pt-12 border-t-2 border-gray-100">
              <div className="max-w-sm ml-auto space-y-4">
                <div className="flex justify-between items-center text-gray-400 font-oswald uppercase tracking-widest text-sm">
                  <span>Subtotal</span>
                  <span className="text-winterella-black">
